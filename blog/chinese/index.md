...
> 一视同仁  <small>yīshì tóngrén</small><br>
...
> 者 / 着 <small>zhě/zhe</small><br>
> noun forming -er / pre.perf. forming -ing

<br><br>
## 变调规则 Tone sandhi rules
<br>

[Third tone:](https://chinese.stackexchange.com/questions/21395/generalize-consecutive-third-tones-change-rule)
  * 3 × * -> low,falling(半三) × *
  * 3 × 3 -> 2 × 3
  * (3×3) × 3 -> 2×2 × 3
  * 3 × (3×3) -> 半三 × 2×3
...
Neutral tone:
A little lower than the preceding tone's end, but after a third tone, higher.

<br><br>
## 双声调练 Tone pair drills
<br>

> 上海 / 伤害 <small>Shànghǎi / shānghài</small>

<br><br>
## 嵌套发挥 Nested elaborations
<br>
...
<pre>
  -------------------------------------
  程度变化      chéngdù biànhuà   change in degree
  自欺欺人      zìqī-qīrén        deceive oneself and others
  新书上架      xīnshūshàngjià    new book releases
  总的说来      zǒngdeshuōlái     generally speaking
  鉅贵          jùguì             super expensive
  我向你道歉    wǒxiàngnǐ dàoqiàn I apologize to you
  您亲手把的饺子nínqīnshǒubǎ dejiǎozi your personally made dumplings
  想多了        xiǎngduòle        overthinking
  跟着我有肉吃  gēnzhewǒyǒuròuchī "go with me you'll have a good life"
  闻名不如见面  wénmíngbùrújiànmiàn by reputation is not like meeting
  生动活泼      shēngdòng huópo   lively,vigorous
  女人之间      nǚren zhījiān     among women
  争风吃醋      zhēngfēngchīcù    jealous rivals for favor,love
  所见所闻      suǒjiànsuǒwén     what one sees and hears
  姐妹相像      jiěmèi xiāngxiàng sisters look alike
  阎王爷        Yánwangyé         Yama, king of hell
  过河拆桥      guòhéchāiqiáo     (one should not) burn crossed bridges
  设定目标      shèdìng mùbiāo    to set goals
  士农工商      shìnónggōngshāng  ancient China's 4 classes: scholar,farmer,artisan,merchant
